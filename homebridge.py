...
class HomeBridge(YomboModule):
    ...
    def _load_(self, **kwargs):
        # self.config_file = yield self._SQLDict.get(self, "configitems5")  # store transports and access tokens here.
        ...
        try:
            self.apiauth = yield self._APIAuth.get_all('Homebridge')
            # self.apiauth = self._APIAuth.rotate('Homebridge')
        except KeyError:
    ...
    def _webinterface_module_config_(self, **kwargs):
        ...
        :return:
        """
        return '/modules_settings/homebridge/index'
                ...
                'nav_side': [
                    {
                        ...
                        'url': '/modules_settings/homebridge/index',
                        'tooltip': '',
                        'opmode': 'run',
                    },
                ],
    ...
    def start_homebridge(self):
        ...
        # command = ['homebridge', "-D", "-U", self.module_path, "-P", self.module_path+"homebridge-yombo/"]
